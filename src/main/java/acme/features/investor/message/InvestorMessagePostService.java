...
@Service
public class InvestorMessagePostService implements AbstractCreateService<Investor, Message> {
	...
	public void validate(final Request<Message> request, final Message entity, final Errors errors) {
		...
		errors.state(request, request.getModel().getBoolean("confirm"), "confirm", "investor.message.form.label.error.must-confirm");
