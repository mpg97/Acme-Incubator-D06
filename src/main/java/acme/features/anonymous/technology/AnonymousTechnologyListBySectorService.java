...
@Service
public class AnonymousTechnologyListBySectorService implements AbstractListService<Anonymous, Technology> {
	...
	public Collection<Technology> findMany(final Request<Technology> request) {
		...
		Collection<Technology> result = this.repository.findAllTechnologiesOrderedBySector();
