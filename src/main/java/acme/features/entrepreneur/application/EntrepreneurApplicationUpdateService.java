...
public class EntrepreneurApplicationUpdateService implements AbstractUpdateService<Entrepreneur, Application> {
	...
	public void validate(final Request<Application> request, final Application entity, final Errors errors) {
		...
		if (!errors.hasErrors("justification")) {
			Boolean isRejected = entity.getStatement().equals(ApplicationStatement.REJECTED);
			Boolean isEmpty = entity.getJustification().isEmpty();
			errors.state(request, !(isRejected && isEmpty), "justification", "entrepreneur.application.denied.justification");
		}
