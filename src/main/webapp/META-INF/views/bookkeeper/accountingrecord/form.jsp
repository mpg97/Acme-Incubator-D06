...
<acme:form readonly="true">
	...
	<acme:form-textbox code="bookkeeper.accounting-record.form.label.investmentRound.title" path="investmentRound.title" />
	<acme:form-textbox code="bookkeeper.accounting-record.form.label.investmentRound.ticker" path="investmentRound.ticker" />
	<acme:form-textbox code="bookkeeper.accounting-record.form.label.bookkeeper.firmName" path="bookkeeper.firmName" />
